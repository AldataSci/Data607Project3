---
title: "PROJECT-3"
author:"Team Sloth (Al,Benson,Jay)"
date: "3/21/2022"
output:
...
## Approach:(Benson)
  I looked at which industry were hiring data scientists and try to figure out which industry are able to hire data scientists. I also looked at which job-types i.e data-analysts,data engineer and data scientists got paid the most. 
...
## Conclusion: (Benson) 
  From the graphs we can see that companies with amount of reveneues are able to hire more data scientists, while data analysts got frequently paid less than 80k,data engineer got paid between 120-139K frequently and finally data scientists getting a higher count of pay than data_engineer and data analysts. 
...
## Understanding the data
 To better understand the graph, it had added the numbers of skills from each job-posting and added each # of skills its relevant industry. So for example if a job posting under govt industry required u know to 2 programming languages and another govt industry job posting required you to know 3 programming languages then the number of skills under govt would be 5.I used this approach to better understand how many programming "skills" are required for each industry and for which specific salary range. 
